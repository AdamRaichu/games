var Electabuzz = new POKEMON(
  ...
  0,
  2,
  [new MOVE([3, 10],"Low Kick",20,""), 
   new MOVE([3, 10, 10],"Magnetic Blast",50,"")],
  5,
  null,
  2)
...
var Pikachu = new POKEMON(
  ...
  0,
  1,
  [new MOVE([3],"Agility",10,"Flip a coin. If head, prevent all effects of attack, including damage, done to this Pokemon during your opponent's next turn.")],
  5,
  null,
  1)
