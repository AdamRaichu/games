function loadMap(mapObject) {
  ...
  window.player = new PLAYER(new MAP(mapObject.mapName, mapObject.matrix, document.getElementById("target"), mapObject.portals, mapObject.ladders), mapObject.x, mapObject.y);
  player.map.generate();
